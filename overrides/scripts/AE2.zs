...
<appliedenergistics2:material:31>.addTooltip(format.yellow("Allows, importing/exporting more then one type of item from a machine, 1 card is 4 slots, and 2 is 9 slots.")); //capacity card

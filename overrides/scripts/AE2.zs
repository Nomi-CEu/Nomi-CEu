...
<appliedenergistics2:material:58>.addTooltip(format.yellow("Used in interfaces. Allows you to put more patterns in an interface then normally allowed up to 4x the normal amount of patterns. Check the Quest Book for more information."));
<appliedenergistics2:material:53>.addTooltip(format.yellow("Allows machines to craft items as they are used up automatically."));
<appliedenergistics2:material:30>.addTooltip(format.yellow("Speeds up various ae2 processes such as exporting things into a machine, speeding up molecular accelerators."));

...
[<ore:foilTitanium>, <advancedrocketry:pressuretank:1>, <minecraft:enchanted_book>.withTag({StoredEnchantments: [{lvl: 4 as short, id: 36 as short}]}), <advancedrocketry:pressuretank:1>, <ore:foilTitanium>], 

...
static ItemStack addNBT(ItemStack stack, boolean trim, boolean front) {
    var sideStack = item('xtones:zane')
    var trimStack = trim ? item('extendedcrafting:storage', 4) : ItemStack.EMPTY
    var frontStack = front ? item('xtones:zane', 15) : ItemStack.EMPTY

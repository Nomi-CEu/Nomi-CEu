...
crafting.shapedBuilder()
    ...
    .matrix('PPP',
            'CCC',
			'BBB')
    .key('P', metaitem('craftingLensLightBlue')) // TODO FIXME crafting lens (glass) not diamond
    .key('C', item('solarflux:photovoltaic_cell_3'))
    .key('B', metaitem('meshPulsating'))
    .register()
...
crafting.shapedBuilder()
    ...
    .key('M', metaitem("ingotMicroversium"))
